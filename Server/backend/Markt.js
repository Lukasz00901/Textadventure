...
const marketItems = [
  ...
  { name: 'Besen', type: 'Speise', price: 4, worth: 2, strength: 5, category: 'consumable', quantity: 10 },
  { name: 'Apfel', type: 'Speise', price: 2, worth: 1, strength: 3, category: 'consumable', quantity: 10 },
  { name: 'Ei', type: 'Speise', price: 4, worth: 2, strength: 3, category: 'consumable', quantity: 10 },
  { name: 'Ziegenkäserad', type: 'Skyrim ?!', price: 10, worth: 5, strength: 15, category: 'consumable', quantity: 10 },
  { name: 'Harzer Roller', type: 'Speise', price: 4, worth: 2, strength: 3, category: 'consumable', quantity: 10 },
  { name: 'Kürbiskuchen', type: 'Speise', price: 6, worth: 3, strength: 6, category: 'consumable', quantity: 10 },
  { name: 'Nüsse', type: 'Speise', price: 4, worth:6, strength: 3, category: 'consumable', quantity: 10 },
];
